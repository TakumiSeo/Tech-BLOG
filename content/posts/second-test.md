Title: Second Verification Log
Date: 2025-01-20
Slug: second-post
Category: notebook
Tags: azure,static-web-apps,aks
...
## Sample Snippet
The first automated deployment will validate that the GitHub Actions workflow produces the exact artifact Azure Static Web Apps expect