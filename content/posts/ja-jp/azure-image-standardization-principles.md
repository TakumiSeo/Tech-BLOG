...
![VM Image Builder による発行自動化フロー](images/azure-image-standardization-principles/aib-publish-flow.drawio.svg)

（編集ソース：[content/images/azure-image-standardization-principles/aib-publish-flow.drawio](content/images/azure-image-standardization-principles/aib-publish-flow.drawio)）
